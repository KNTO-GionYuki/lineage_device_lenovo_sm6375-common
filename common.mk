...
##Kernel
#PRODUCT_COPY_FILES += \
	$(LOCAL_PATH)/modules.alias:$(TARGET_COPY_OUT_VENDOR_DLKM)/modules/modules.alias	\
	$(LOCAL_PATH)/modules.dep:$(TARGET_COPY_OUT_VENDOR_DLKM)/modules/modules.dep		\
	$(LOCAL_PATH)/modules.softdep:$(TARGET_COPY_OUT_VENDOR_DLKM)/modules/modules.softdep
...
$(call inherit-product, vendor/lenovo/sm6375-common/sm6375-common-vendor.mk)
